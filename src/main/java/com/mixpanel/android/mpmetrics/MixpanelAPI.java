 ...
 *
 * <p>Call {@link #getInstance(Context, String, boolean, RemoteProvider)} with
...
public class MixpanelAPI {
     ...
     */
    MixpanelAPI(Context context, Future<SharedPreferences> referrerPreferences, String token, boolean optOutTrackingDefault, JSONObject superProperties, boolean trackAutomaticEvents, RemoteProvider remoteProvider) {
        this(context, referrerPreferences, token, MPConfig.getInstance(context), optOutTrackingDefault, superProperties, remoteProvider, null, trackAutomaticEvents);
    }
     ...
     * Use MixpanelAPI.getInstance to get an instance.
     */
    MixpanelAPI(Context context, Future<SharedPreferences> referrerPreferences, String token, boolean optOutTrackingDefault, JSONObject superProperties, String instanceName, boolean trackAutomaticEvents, RemoteProvider remoteProvider) {
        this(context, referrerPreferences, token, MPConfig.getInstance(context), optOutTrackingDefault, superProperties, remoteProvider, instanceName, trackAutomaticEvents);
    }
     ...
     * Use MixpanelAPI.getInstance to get an instance.
     */
    MixpanelAPI(Context context, Future<SharedPreferences> referrerPreferences, String token, MPConfig config, boolean optOutTrackingDefault, JSONObject superProperties, RemoteProvider remoteProvider, String instanceName, boolean trackAutomaticEvents) {
        mContext = context;
        mToken = token;
     ...
     */
    public static MixpanelAPI getInstance(Context context, String token, boolean trackAutomaticEvents, RemoteProvider remoteProvider) {
        return getInstance(context, token, false, null, null, trackAutomaticEvents, remoteProvider);
    }
     ...
     * @return an instance of MixpanelAPI associated with your project
     */
    public static MixpanelAPI getInstance(Context context, String token, String instanceName, boolean trackAutomaticEvents, RemoteProvider remoteProvider) {
        return getInstance(context, token, false, null, instanceName, trackAutomaticEvents, remoteProvider);
    }
     ...
     * @return an instance of MixpanelAPI associated with your project
     */
    public static MixpanelAPI getInstance(Context context, String token, boolean optOutTrackingDefault, boolean trackAutomaticEvents, RemoteProvider remoteProvider) {
        return getInstance(context, token, optOutTrackingDefault, null, null, trackAutomaticEvents, remoteProvider);
    }
     ...
     * @return an instance of MixpanelAPI associated with your project
     */
    public static MixpanelAPI getInstance(Context context, String token, boolean optOutTrackingDefault, String instanceName, boolean trackAutomaticEvents, RemoteProvider remoteProvider) {
        return getInstance(context, token, optOutTrackingDefault, null, instanceName, trackAutomaticEvents, remoteProvider);
    }
     ...
     * @return an instance of MixpanelAPI associated with your project
     */
    public static MixpanelAPI getInstance(Context context, String token, JSONObject superProperties, boolean trackAutomaticEvents, RemoteProvider remoteProvider) {
        return getInstance(context, token, false, superProperties, null, trackAutomaticEvents, remoteProvider);
    }
     ...
     * @return an instance of MixpanelAPI associated with your project
     */
    public static MixpanelAPI getInstance(Context context, String token, JSONObject superProperties, String instanceName, boolean trackAutomaticEvents, RemoteProvider remoteProvider) {
        return getInstance(context, token, false, superProperties, instanceName, trackAutomaticEvents, remoteProvider);
    }
     ...
     * @return an instance of MixpanelAPI associated with your project
     */
    public static MixpanelAPI getInstance(Context context, String token, boolean optOutTrackingDefault, JSONObject superProperties, String instanceName, boolean trackAutomaticEvents, RemoteProvider remoteProvider) {
        ...
        synchronized (sInstanceMap) {
            ...
            if (null == instance && ConfigurationChecker.checkBasicConfiguration(appContext)) {
                instance = new MixpanelAPI(appContext, sReferrerPrefs, token, optOutTrackingDefault, superProperties, instanceName, trackAutomaticEvents, remoteProvider);
     ...
     * {@link
     * MixpanelAPI#getInstance(Context, String, boolean, JSONObject, String, boolean, RemoteProvider)} for more information.
     *
    ...
    /* package */ AnalyticsMessages getAnalyticsMessages() {
        return AnalyticsMessages.getInstance(mContext, mConfig, remoteProvider);
    }
